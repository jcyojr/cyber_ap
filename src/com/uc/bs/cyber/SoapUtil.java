...
public class SoapUtil 
{
    ...
    public Element getSOAPMessage(StringBuffer reqXml,String usecaseId, String eventId, String sgcd) throws Exception 
    {


    	String mode=CbUtil.getResource("ApplicationResource", "cyber.mode");
        String target = "";
        
    	if(mode.equals("TEST")) target = CbUtil.getResource("ApplicationResource", "cyber.wsdl.target.test");
    	else target = CbUtil.getResource("ApplicationResource", "cyber.wsdl.target."+ sgcd);
    	
        log.info("sgcd=" + sgcd + ", target :  "+target);

        SoapUtil st = new SoapUtil();
