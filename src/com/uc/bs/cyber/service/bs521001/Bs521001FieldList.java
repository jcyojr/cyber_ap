 ...
 *  주시스템명 : 사이버지방세청 고도화
 *  업  무  명 : 내부 전문 송수신 연계
 *  기  능  명 : 부산은행-지방세 고지내역 간략조회 - 목록 전문셋팅
 *              
 *  클래스  ID : Bs521001FieldList
 *  변경  이력 :
 * ------------------------------------------------------------------------
 *  작성자     소속  		 일자      Tag   내용
 * ------------------------------------------------------------------------   
...
public class Bs521001FieldList extends Comd_WorkKfField {
	...
	public Bs521001FieldList() {
		...
		this.addRepetField("TAXNO"           , 29 ,  "C");  /*납부번호	                 */
		this.addRepetField("SEQNO"           , 5  ,  "H");  /*일련번호	                */
		this.addRepetField("GWA_MOK"         , 6  ,  "H");  /*과목/세목                 */
		this.addRepetField("GWA_YM"          , 6  ,  "H");  /*과세년월                  */
		this.addRepetField("KIBUN"           , 1  ,  "H");  /*기분                      */
