 ...
 *
 */
public class Df533001Tax004FieldList extends Comd_WorkDfField {
				
	/**
	 * 생성자
	 * 상세조회 전문생성
	 */
	public Df533001Tax004FieldList() {
		...
		addSendField("RVSN_YY"              , 4   ,  "C"  );  /*귀속년월                */
		addSendField("KJSA"                 , 13  ,  "H"  );  /*종합소득세              */
		addSendField("JMSA"                 , 13  ,  "H"  );  /*주민세 종소  A          */
