...
public class Df533001Tax006FieldList extends Comd_WorkDfField {
	...
	public Df533001Tax006FieldList() {
		...
		addSendField("SUM_RCP"              , 13  ,  "H"  );  /*납부총액  A+B+C     */
		...
		addSendField("ADDR"                 , 40  ,  "C"  );  /*세부주소(납세자주소)   */	
		addSendField("CMP_NM"               , 30  ,  "C"  );  /*세부주소(납세자주소)   */	
		addSendField("SAUP_NO"              , 10  ,  "C"  );  /*사업자번호             */		
		addSendField("JSDT"                 , 8   ,  "C"  );  /*귀속사업시작기간       */
		addSendField("JEDT"                 , 8   ,  "C"  );  /*귀속사업종료기간       */		
		addSendField("TJUS"                 , 10  ,  "H"  );  /*종업원(전체)           */
		addSendField("JUWS"                 , 10  ,  "H"  );  /*종업원(시구군)         */
		addSendField("TCNT"                 , 10  ,  "H"  );  /*건축물면적(전체)       */
		addSendField("SASU"                 , 10  ,  "H"  );  /*건축물면적(시구군)     */		
		addSendField("KJSA"                 , 13  ,  "H"  );  /*법인세 법인전체총액    */
		addSendField("JMSA"                 , 13  ,  "H"  );  /*주민세 관내분만 세액 A */
		addSendField("F_DUE_DT"             , 8   ,  "C"  );  /*당초 납부 기한         */
		addSendField("DLQ_CNT"              , 3   ,  "H"  );  /*납부지연일수           */
		addSendField("NGAS"                 , 11  ,  "H"  );  /*납부불성실가산세     B */
		addSendField("RADTX"                , 11  ,  "H"  );  /*신고불성실가산세     C */
		addSendField("ANBR"                 , 10  ,  "C"  );  /*평균비율(3.6)          */
		addSendField("FILLTER"              , 8   ,  "C"  );  /*빈칸                   */
