 ...
 *
 */
public class We272002FieldList{
	...
	public We272002FieldList() {
		...
		field.add("REGNO"          	,  13  , "C");  /*납부의무자 주민(사업자,법인)등록번호 */
		field.add("TOTPAY_NO"       ,  19  , "C");  /*총괄납부 고유번호                    */
		field.add("TOT_CNT"        	,   6  , "H");  /*총괄납부 총 고지 건수                */
		field.add("TOT_SUM_B_AMT"   ,  15  , "H");  /*총괄납부 총 납부 금액                */
		field.add("PAY_DT"        	,   8  , "H");  /*납부 일자                            */
		field.add("BANK_COD"        ,   7  , "C");  /*출금은행 점 별 코드                  */
		field.add("PAY_REG_NO"      ,  13  , "C");  /*납부자 주민(사업자)등록번호          */
		field.add("PAY_SYSTEM"      ,   1  , "C");  /*납부 이용 시스템                     */
		field.add("PAY_FSYSTEM"     ,   1  , "C");  /*기 납부 이용 시스템                  */
		field.add("PAY_FORM"        ,   1  , "C");  /*납부 형태 구분                       */
		field.add("CH_INCLUDE"      ,   1  , "C");  /*수표 포함 여부                       */
