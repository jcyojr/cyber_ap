 ...
 *  기  능  명 : 수기고지서 주민세 종합소득할 소인파일을 파싱하기 위한 필드정의
 *              
 *  클래스  ID : Txdm1272FieldList
 *  변경  이력 :
 * ------------------------------------------------------------------------
 *  작성자     소속  		 일자      Tag   내용
 * ------------------------------------------------------------------------   
...
public class Txdm1272FieldList {
	...
	public Txdm1272FieldList() {
		...
		field.add("BIZ_ZIP_ADDR"       ,60    ,"C" ); /*"납세자우편주소"           */  
		field.add("BIZ_ADDR"           ,100   ,"C" ); /*"납세자 상세주소"          */  
		field.add("MO_TEL"             ,16    ,"C" ); /*"핸드폰번호"               */  
		field.add("BIZ_TEL"            ,16    ,"C" ); /*"납세자 전화번호"          */  
		field.add("BIZ_NO"             ,10    ,"C" ); /*"사업자번호"               */  
		field.add("CMP_NM"             ,50    ,"C" ); /*"상호명"                   */  
		field.add("RVSN_YY"            ,4     ,"C" ); /*"귀속년도"                 */  
		field.add("C_REQ_DT"           ,8     ,"C" ); /*"수정신고일자"             */  
		field.add("DUE_DT"             ,8     ,"C" ); /*"납기일자"                 */  
		field.add("REQ_DIV"            ,1     ,"C" ); /*"신고구분"                 */  
		field.add("INCTX"              ,14    ,"H" ); /*"종합소득세"               */  
		field.add("RSTX_INC"           ,14    ,"H" ); /*"주민세 종합소득세할"      */  
