 ...
 *  클래스  ID : Txdm2473_process : 실 처리로직을 작성하는 클래스
 *  변경  이력 :
 * ------------------------------------------------------------------------
 *  작성자      	소속  		    일자            Tag           내용
 * ------------------------------------------------------------------------
...
public class Txdm2473_process extends Codm_BaseProcess implements Codm_interface {
	...
	private int txdm2473_JobProcess() {
		...
		log.info("=====================================================================");
		log.info("=" + this.getClass().getName()+ " txdm2473_JobProcess()[주정차위반과태료-[" + c_slf_org_nm + "] 부과자료연계] Start =");
		...
		try {
		    ...
		    log.error("TXDM2473 연계 오류 = " + gblNidLevyRows.getMaps());
