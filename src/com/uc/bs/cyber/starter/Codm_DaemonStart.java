...
public class Codm_DaemonStart implements Runnable{
	...
	private static String  procName = "사이버지방세청(KP) 데몬관리";
...
//			/*
//			 * 20130628 --죽어서 안살아나는 경우 강제로 살려야 하므로 추가
...
//					e.printStackTrace();
//				} finally {
//					log.info("=== DAEMON(" + procId + "::" + procName + ") STATE IS 레알 DOWN (ㅠㅠ)");
//				}
//			}
		}		
	...
	private static void setStateRegist(){
		...
		sysMap.setMap("THREAD_NM"    , "Main Daemon(KP) Administrator");           /*쓰레드 명*/
